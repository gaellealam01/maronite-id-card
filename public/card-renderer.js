...
async function renderFrontCard(canvas, { photoSrc, name, idNumber }) {
  ...
  ctx.font = `bold ${nameSize}px "Helvetica Neue", Helvetica, Arial, sans-serif`;
  ...
  ctx.font = `bold ${idSize}px "Helvetica Neue", Helvetica, Arial, sans-serif`;
